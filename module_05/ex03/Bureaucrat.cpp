...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/03 15:43:40 by sismaili          #+#    #+#             */
/*   Updated: 2022/12/03 19:24:24 by sismaili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (form.getItsSigned() && this->getGrade() <= form.getExGrade())
		std::cout << this->getName() << " executed " << form << std::endl;
	else
		std::cout << this->getName() << " couldn't execute " << form << std::endl;
}
