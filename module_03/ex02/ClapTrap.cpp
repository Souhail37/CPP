...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/25 19:03:43 by sismaili          #+#    #+#             */
/*   Updated: 2022/11/25 19:04:12 by sismaili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	if (this->Hit_points > 0 && this->Energy_points > 0)
	{
		...
		std::cout << this->Name << " take damage. Hit points == "
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->Hit_points > 0 && this->Energy_points > 0)
	{
		...
		this->Energy_points--;
		std::cout << this->Name << " has been repaired. Hit points == "
			<< this->Hit_points << std::endl;
	}
}